...
<!--奨学金支給事業-->
<li><a href="/scholarship/"><img src="/common/img/nav_img/nav_activity_scl_rollover.png" alt="奨学金支給事業" width="220" height="30" border="0"></a></li>
...
<h1><img src="/common/img/scholarship_head.png" alt="" width="610" height="200" border="0" id="imghead"></h1>
...
<?php
   $newslist = get_posts( array(
    'category_name' => 'scholarship_info', //特定のカテゴリースラッグを指定
